...
function App() {
  ...
  const handlePredict = async () => {
    setLoading(true);
    try {
      const res = await axios.post("https://ai-powered-studentcareerpathpredictor.onrender.com/predict", formData);
      setResult(res.data);
    } catch (err) {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      const res = await axios.post("https://ai-powered-studentcareerpathpredictor.onrender.com/upload_excel", formDataFile, {
